rem DO NOT EDIT!
rem Generated from sh/make.bat.in (Mon Apr 28 15:23:57 CEST 2008)
rem (c) Andreas Rossberg 2001-2007
rem
...
@set files=%files% syntax/GRAMMAR_CORE-sig.sml
@set files=%files% syntax/GrammarCoreFn.sml
@set files=%files% syntax/GRAMMAR_MODULE-sig.sml
@set files=%files% syntax/GrammarModuleFn.sml
@set files=%files% syntax/GRAMMAR_PROGRAM-sig.sml
@set files=%files% syntax/GrammarProgramFn.sml
@set files=%files% syntax/Grammars.sml
...
@set files=%files% parse/LineAwareLexer.sml
...
@set files=%files% lib/LIBRARY-sig.sml
@set files=%files% lib/Library.sml
...
@set files=%files% syntax/PP_GRAMMAR-sig.sml
@set files=%files% syntax/PPGrammar.sml
...
:mosml
@set fixfiles=
@set fixfiles=%fixfiles% fix/Large-mosml.sml
@set fixfiles=%fixfiles% fix/Word-mosml.sml
@set fixfiles=%fixfiles% fix/Char-mosml.sml
@set fixfiles=%fixfiles% fix/String-mosml.sml
@set fixfiles=%fixfiles% fix/Real-mosml.sml
@set fixfiles=%fixfiles% fix/ListPair-mosml.sml
@set fixfiles=%fixfiles% fix/TextIO-mosml.sml
@set fixfiles=%fixfiles% fix/OS-mosml.sml
@set files=%fixfiles% %files%
copy fix/Large.sml fix/Large-mosml.sml
copy fix/Word.sml fix/Word-mosml.sml
copy fix/Char.sml fix/Char-mosml.sml
copy fix/String.sml fix/String-mosml.sml
copy fix/ListPair.sml fix/ListPair-mosml.sml
copy fix/TextIO.sml fix/TextIO-mosml.sml
copy fix/OS.sml fix/OS-mosml.sml
